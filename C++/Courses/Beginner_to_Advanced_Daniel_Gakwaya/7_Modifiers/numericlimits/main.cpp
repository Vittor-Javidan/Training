...
int main()
{
   ...
   std::cout << "The range for float(with lowest) is from " << std::numeric_limits<float>::lowest()
             << " to " << std::numeric_limits<float>::max() << std::endl;

   std::cout << "The range for double(with lowest) is from " << std::numeric_limits<double>::lowest()
             << " to " << std::numeric_limits<double>::max() << std::endl;

   std::cout << "The range for long(with lowest) is from " << std::numeric_limits<long>::lowest()
             << " to " << std::numeric_limits<long>::max() << std::endl;
